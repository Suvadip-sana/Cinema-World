...
<body>
    <form action="confarm1.jsp" method="post">
        <center>        
            ...
            <p>
                <input class="seat" type="checkbox" name="" value="" checked="true" disabled="true">
                <i class="sold">Sold</i> 
                &nbsp;&nbsp;&nbsp;
                <input class="seat" type="checkbox" onclick="return false" checked>
                <i class="selected">Selected</i> 
                &nbsp;&nbsp;&nbsp; 
                <input class="seat" type="checkbox" onclick="return false">
                <i class="available">Available</i>
            </p>
            <div class="container">
                <div class="screen">
                    <p class="screen1">All eyes this way please!</p>
                </div>
            </div>
            <%
            ...
            <p style="color: #ff0000;"> If you don't select any seat, you will not able to proceed further!!</p>
            <input class="none" type="submit" value="Book" disabled>                  
        </center>
    </form>
</body>
